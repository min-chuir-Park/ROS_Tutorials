...
if("TRUE" STREQUAL "TRUE")
  set(multimaster_SOURCE_PREFIX /home/nvidia/ROS_Tutorials/catkin_ws/src/ros_c++/function_ws/multimaster)
  set(multimaster_DEVEL_PREFIX /home/nvidia/ROS_Tutorials/catkin_ws/devel)
  ...
  set(multimaster_INSTALL_PREFIX /home/nvidia/ROS_Tutorials/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'multimaster' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'multimaster' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/ROS_Tutorials/catkin_ws/src/ros_c++/function_ws/multimaster/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${multimaster_dep}_FOUND)
      find_package(${multimaster_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${multimaster_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
